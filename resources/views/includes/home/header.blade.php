<nav class="navbar" style="height:100%">
          <div class="container-fluid" style="height:100%">
              <div class="navbar-header" style="height:100%">
                  <a class="navbar-brand" href="#" style="padding:0;height:100%">
                      <img class="logo" src="/img/nombre.png">
                  </a>
              </div>
              <ul class="nav navbar-nav navbar-right" style="height:100%">
                  <li style="height:100%;margin-right:0px"><a href="#" style="height:100%;padding-top:15%"><span class="fa fa-sign-out" style="margin:0"></span></a></li>
