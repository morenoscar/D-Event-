  ...
  <div class="panel-heading " >
    ...
    <div class="panel-body">
      ...
      <div align="center">
        ...
        <button type="button" class="btn btn-info " style="background-color:#31B0D5; "  class="launch-modal" data-modal-id="modal-edit-event">
      ...
      {!! Form::button('<i class="fa fa-trash" style="color:white;"></i><a class="butstyle">Eliminar</a>', array('type'=>'submit','class'=>'btn', 'style'=>'background-color:#C9302C; ')) !!}
